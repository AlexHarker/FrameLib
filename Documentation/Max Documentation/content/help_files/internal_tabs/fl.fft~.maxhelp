...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 15.0, 15.0, 654.0, 75.0 ]
								}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 255.0, 103.5, 330.0, 65.0 ],
									"text" : "fl.fft~ takes the FFT on an incoming frame. It may be set to real input and ouput, complex input and output or full_specturm for which a real input will produce full output with reflection at the nyquist frequency.",
									"textjustification" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 267.0, 359.0, 373.0, 25.0 ],
									"text" : "Takes the FFT of the incoming window (full spectrum output)"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 169.0, 403.0, 338.0, 25.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 105.0, 404.0, 58.0, 23.0 ],
									"text" : "fl.hypot~"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 410.0, 573.0, 223.0, 40.0 ],
									"text" : "Observe the magnitude spectrum (in dB) here with reflection",
									"textjustification" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 105.0, 449.0, 124.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 105.0, 540.0, 299.0, 106.0 ],
									"setminmax" : [ -120.0, 0.0 ],
									"size" : 1024,
									"slidercolor" : [ 0.952941176470588, 0.564705882352941, 0.098039215686275, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 105.0, 495.0, 62.0, 23.0 ],
									"text" : "fl.tomax~"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"numoutlets" : 0,
									"patching_rect" : [ 30.0, 570.5, 45.0, 45.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 105.0, 359.0, 157.0, 23.0 ],
									"text" : "fl.fft~ /mode full_spectrum"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 165.5, 224.0, 101.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 105.0, 274.0, 140.0, 23.0 ],
									"text" : "fl.source~ /length 1024"
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-38", 1 ],
									"midpoints" : [ 39.5, 537.0, 65.5, 537.0 ],
									"order" : 1,
									"source" : [ "obj-14", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-5", 0 ],
									"midpoints" : [ 39.5, 226.0, 114.5, 226.0 ],
									"order" : 0,
									"source" : [ "obj-14", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-1", 1 ],
									"midpoints" : [ 252.5, 392.5, 153.5, 392.5 ],
									"source" : [ "obj-8", 1 ]
								}
...
,
		...
		"lines" : [  ],
		"parameters" : 		{
			"obj-1::obj-14::obj-21::obj-6" : [ "live.tab[3]", "live.tab[1]", 0 ],
			"obj-1::obj-14::obj-35" : [ "[5]", "Level", 0 ],
			"obj-3::obj-14::obj-21::obj-6" : [ "live.tab[4]", "live.tab[1]", 0 ],
			"obj-3::obj-14::obj-35" : [ "[1]", "Level", 0 ],
			"parameterbanks" : 			{
