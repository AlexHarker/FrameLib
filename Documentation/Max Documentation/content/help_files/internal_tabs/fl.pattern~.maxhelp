...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 119.5, 528.0, 122.0, 25.0 ],
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 30.0, 525.0, 90.0, 45.0 ],
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"numoutlets" : 0,
									"patching_rect" : [ 30.0, 593.0, 45.0, 45.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 105.0, 597.5, 510.0, 36.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 428.0, 303.17567567567562, 146.0, 40.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 112.0, 438.17567567567562, 209.0, 25.0 ],
									"text" : "Applies envelope to avoid clicks"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 194.0, 138.17567567567562, 161.0, 25.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 50.0, 105.0, 135.0, 23.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 50.0, 146.0, 172.0, 23.0 ],
													"text" : "fl.pad~ /end 100 /units ratios"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 50.0, 66.0, 179.0, 23.0 ],
													"text" : "fl.random~ /length 3 /units ms"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 18.0, 139.0, 284.0, 23.0 ],
													"text" : "fl.*~"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 18.0, 103.0, 41.0, 23.0 ],
													"text" : "fl.-~ 1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 40.0, 67.0, 232.0, 23.0 ],
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 18.0, 175.0, 30.0, 30.0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 292.5, 60.5, 49.5, 60.5 ],
													"order" : 1,
													"source" : [ "obj-27", 0 ]
												}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 39.5, 581.0, 65.5, 581.0 ],
									"order" : 0,
									"source" : [ "obj-12", 0 ]
								}
...
,
		...
		"lines" : [  ],
		"parameters" : 		{
			"obj-1::obj-12::obj-50" : [ "live.gain~[1]", "Volume", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
