...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"text" : "fl.uniform~ generates a frame consisting of a single uniformly value."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 450.0, 325.0, 23.0, 21.0 ],
									"text" : "10",
									"textjustification" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 452.0, 390.0, 19.0, 21.0 ],
									"text" : "0",
									"textjustification" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"numoutlets" : 0,
									"patching_rect" : [ 536.0, 345.0, 45.0, 45.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 270.0, 285.0, 62.0, 23.0 ],
									"text" : "fl.tomax~"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 165.0, 375.0, 50.0, 23.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 165.0, 285.0, 51.0, 23.0 ],
									"text" : "fl.sum~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 165.0, 330.0, 62.0, 23.0 ],
									"text" : "fl.tomax~"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 60.0, 375.0, 50.0, 23.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 60.0, 180.0, 54.0, 23.0 ],
									"text" : "fl.once~"
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 69.5, 266.0, 174.5, 266.0 ],
									"order" : 1,
									"source" : [ "obj-2", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-4", 0 ],
									"midpoints" : [ 69.5, 266.0, 279.5, 266.0 ],
									"order" : 0,
									"source" : [ "obj-2", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-7", 0 ],
									"midpoints" : [ 69.5, 258.5, 69.5, 258.5 ],
									"order" : 2,
									"source" : [ "obj-2", 0 ]
								}
