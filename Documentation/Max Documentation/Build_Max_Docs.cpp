...
void write_info()
    {
        ...
        objectNames.resize(6);
        objectNames[0] = "fl.interval~";
        objectNames[1] = "fl.source~";
        objectNames[2] = "fl.random~";
        objectNames[3] = "fl.ramp~";
        objectNames[4] = "fl.gaussian~";
        objectNames[5] = "fl.map~";
    
        // Create a Global, Context
        FrameLib_Global *Global = nullptr;
        FrameLib_Global::get(&Global);
        std::vector<FrameLib_Multistream *> cpp_objects;
        cpp_objects.resize(6);
        FrameLib_Proxy *Proxy = new FrameLib_Proxy();
        FrameLib_Context context(Global, nullptr);
        FrameLib_Parameters::AutoSerial parameters;
        
        cpp_objects[0] = new FrameLib_Expand<FrameLib_Interval>(context, nullptr, Proxy, 1);
        cpp_objects[1] = new FrameLib_Expand<FrameLib_Source>(context, nullptr, Proxy, 1);
        cpp_objects[2] = new FrameLib_Expand<FrameLib_Random>(context, nullptr, Proxy, 1);
        cpp_objects[3] = new FrameLib_Expand<FrameLib_Ramp>(context, nullptr, Proxy, 1);
        cpp_objects[4] = new FrameLib_Expand<FrameLib_Gaussian>(context, nullptr, Proxy, 1);
        cpp_objects[5] = new FrameLib_Expand<FrameLib_Map>(context, nullptr, Proxy, 1);
