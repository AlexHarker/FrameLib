...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 165.0, 285.0, 152.0, 123.0 ],
									"text" : "This abstraction lets you select the convert mode while also providing some example input units. The left output provides the values to convert and the right outlet sets the mode"
								}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 2,
																	"outlettype" : [ "", "" ],
																	"patching_rect" : [ 87.0, 124.0, 234.0, 22.0 ],
																	"text" : "zl.reg -12 0.25119 60 440 12 2 15 6.28319"
																}
...
,
													"patching_rect" : [ 15.0, 285.0, 70.0, 22.0 ],
													"saved_object_attributes" : 													{
														"description" : "",
														"digest" : "",
														"globalpatchername" : "",
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "", "", "float" ],
													"parameter_enable" : 1,
													"patching_rect" : [ 15.0, 45.0, 105.0, 195.0 ],
													"presentation" : 1,
...
,
									"patching_rect" : [ 15.0, 165.0, 135.0, 285.0 ],
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 377.0, 572.75, 49.75, 17.5 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 428.75, 569.25, 105.0, 21.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 255.0, 570.0, 120.0, 23.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 165.0, 427.0, 75.0, 23.0 ],
									"text" : "fl.perblock~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 94.75, 495.0, 124.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 255.0, 615.0, 120.0, 23.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 15.0, 585.0, 98.75, 23.0 ],
									"text" : "fl.convert~"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 377.0, 620.5, 49.75, 12.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 428.75, 616.0, 103.0, 21.0 ],
...
, 							{
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"midpoints" : [ 104.25, 519.0, 104.25, 519.0 ],
									"source" : [ "obj-15", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 174.5, 480.0, 104.25, 480.0 ],
									"order" : 0,
									"source" : [ "obj-17", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 174.5, 480.0, 24.5, 480.0 ],
									"order" : 1,
									"source" : [ "obj-17", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 24.5, 660.0, 144.5, 660.0, 144.5, 606.0, 264.5, 606.0 ],
									"source" : [ "obj-20", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-15", 0 ],
									"midpoints" : [ 140.5, 480.0, 104.25, 480.0 ],
									"source" : [ "obj-6", 1 ]
								}
...
,
		...
		"lines" : [  ],
		"parameters" : 		{
			"obj-1::obj-6::obj-5" : [ "live.tab", "live.tab", 0 ],
			"parameterbanks" : 			{
