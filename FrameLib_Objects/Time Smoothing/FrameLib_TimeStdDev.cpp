...
FrameLib_TimeStdDev::FrameLib_TimeStdDev(FrameLib_Context context, FrameLib_Parameters::Serial *serialisedParameters, void *owner) : FrameLib_TimeBuffer<FrameLib_TimeStdDev>(context, serialisedParameters, owner), mSum(NULL), mCompensate(NULL), mSqSum(NULL), mSqCompensate(NULL)
{
}
...
FrameLib_TimeStdDev::ParameterInfo FrameLib_TimeStdDev::sParamInfo;

FrameLib_TimeStdDev::ParameterInfo::ParameterInfo()
{
