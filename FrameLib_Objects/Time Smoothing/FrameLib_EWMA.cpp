...
FrameLib_EWMA::FrameLib_EWMA(FrameLib_Context context, FrameLib_Parameters::Serial *serialisedParameters, void *owner) : FrameLib_Processor(context, owner, &sParamInfo, 2, 1), mAverageFrame(NULL), mPrevFrame(NULL), mFrameSize(0)
{
