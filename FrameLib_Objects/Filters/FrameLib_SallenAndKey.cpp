...
FrameLib_SallenAndKey::FrameLib_SallenAndKey(FrameLib_Context context, const FrameLib_Parameters::Serial *serialisedParameters, FrameLib_Proxy *proxy) : FrameLib_Processor(context, proxy, &sParamInfo, 2, 1)
{
...
{
    return formatInfo("Filters input frames using a sallen and key filter: The size of the output is equal to the input.",
