...
namespace FrameLib_Filters
{
    ...
    public:
        ...
        {
            Mode("lpf", "Low Pass Output", "low pass", &SallenAndKey::lpf),
            Mode("bpf", "Band Pass Output", "band pass", &SallenAndKey::bpf),
            Mode("hpf", "High Pass Output", "high pass", &SallenAndKey::hpf)
        };
