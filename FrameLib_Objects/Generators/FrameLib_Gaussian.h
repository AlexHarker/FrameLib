...
class FrameLib_Gaussian final : public FrameLib_Processor
{
    ...
    enum ParameterList { kMode, kLength, kUnits, kMean, kStdDev };
...
public:
    ...
    FrameLib_Gaussian(FrameLib_Context context, const FrameLib_Parameters::Serial *serialisedParameters, FrameLib_Proxy *proxy);
