...
FrameLib_CoordinateSystem::FrameLib_CoordinateSystem(FrameLib_Context context, const FrameLib_Parameters::Serial *serialisedParameters, FrameLib_Proxy *proxy)
