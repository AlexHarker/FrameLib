                        ...
                        "boxes": [
                                        ...
                                        "boxes": [
                                            ...
                                            },
                                            {
                                                "box": {
                                                    ...
                                                    "text": "fl.complex.pow~ /trigger_ins right"
                                                }
                                            },
                                            {
                                                "box": {
                                            ...
                                            },
                                            {
                                                "box": {
                                                    ...
                                                    "text": "fl.complex.pow~ /trigger_ins left"
                                                }
                                            },
                                            {
                                                "box": {
                                                    ...
                                                    "text": "fl.complex.pow~ /trigger_ins both"
                                                }
                                            }
                                        ],
                                        "lines": [
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "text": "FrameLib complex binary operators have a /trigger_ins parameter that sets which pairs of inputs trigger calculation.\n\nBelow you can select which input pairs (hence scheduler(s)) drive the calculation of fl.complex.pow~ (there are three different versions encapsulated in p \"trigger ins\"). You'll see the most obvious difference when switching between either left or both to right, where calculation will slow down to once every 1.3 seconds."
                                }
                            },
                            {
                                "box": {
                                        ...
                                        "boxes": [
                                            ...
                                            },
                                            {
                                                "box": {
                                                    ...
                                                    "text": "fl.complex.pow~ /mismatch pad_out"
                                                }
                                            },
                                            {
                                                "box": {
                                                    ...
                                                    "text": "fl.complex.pow~ /mismatch pad_in"
                                                }
                                            },
                                            {
                                                "box": {
                                            ...
                                            },
                                            {
                                                "box": {
                                                    ...
                                                    "text": "fl.complex.pow~ /mismatch shrink"
                                                }
                                            },
                                            {
                                                "box": {
                                                    ...
                                                    "text": "fl.complex.pow~ /mismatch wrap"
                                                }
                                            }
                                        ],
                                        "lines": [
