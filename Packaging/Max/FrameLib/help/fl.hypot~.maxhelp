                        ...
                        "boxes": [
                                        ...
                                        "boxes": [
                                            ...
                                            },
                                            {
                                                "box": {
                                                    ...
                                                    "text": "fl.hypot~ /trigger_ins both"
                                                }
                                            }
                                        ],
                                        "lines": [
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "text": "FrameLib binary operators have a /trigger_ins parameter that sets which inputs trigger calculation. \n\nBelow you can select which inputs (and hence scheduler(s)) drive the calculation of fl.hypot~ (there are three different versions encapsulated in p \"trigger ins\"). You'll see the most obvious difference when switching between either left or both to right, where calculation will slow down to once every 1.3 seconds."
                                }
                            },
                            {
                                "box": {
