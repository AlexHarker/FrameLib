...
FrameLib_Pack::FrameLib_Pack(FrameLib_Context context, FrameLib_Parameters::SerialBase *serialisedParameters, void *owner) : FrameLib_MultiChannel(context)
{
...
FrameLib_Unpack::FrameLib_Unpack(FrameLib_Context context, FrameLib_Parameters::SerialBase *serialisedParameters, void *owner) : FrameLib_MultiChannel(context)
{
