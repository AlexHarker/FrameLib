...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 180.0, 60.0, 491.0, 38.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 555.0, 435.0, 153.0, 100.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"numoutlets" : 0,
									"patching_rect" : [ 180.0, 645.0, 45.0, 45.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "" ],
									"patching_rect" : [ 180.0, 480.0, 110.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 180.0, 537.0, 43.0, 90.0 ],
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 271.0, 569.0, 298.0, 121.0 ],
									"size" : 2708
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 690.0, 256.0, 20.0, 20.0 ],
									"rounded" : 60.0,
									"text" : "2",
									"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-19", 1 ],
									"midpoints" : [ 232.999995814697286, 615.0, 216.499995814697286, 615.0 ],
									"source" : [ "obj-67", 1 ]
								}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"numoutlets" : 0,
									"patching_rect" : [ 495.0, 420.0, 55.0, 22.0 ],
									"text" : "dac~ 1 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 495.0, 375.0, 94.0, 22.0 ],
									"text" : "index~ 2_duduk"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 211.0, 375.0, 33.0, 22.0 ],
									"text" : "!-~ 1"
								}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 49.0, 212.0, 29.5, 22.0 ],
													"text" : "!- 1"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 49.0, 337.0, 30.0, 30.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 8.0, 46.0, 32.0, 22.0 ],
													"text" : "t b b"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 96.0, 212.0, 52.0, 22.0 ],
													"text" : "$1 2500"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 49.0, 46.0, 70.0, 22.0 ],
													"text" : "loadmess 0"
												}
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "int" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 49.0, 127.0, 24.0, 24.0 ]
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-4", 0 ],
													"midpoints" : [ 30.5, 114.0, 58.5, 114.0 ],
													"source" : [ "obj-24", 1 ]
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-9", 0 ],
													"midpoints" : [ 58.5, 150.0, 105.5, 150.0 ],
													"order" : 0,
													"source" : [ "obj-4", 0 ]
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-4", 0 ],
													"midpoints" : [ 58.5, 114.0, 58.5, 114.0 ],
													"source" : [ "obj-6", 0 ]
												}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 180.0, 549.0, 29.5, 22.0 ],
									"text" : "+~"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 332.25, 172.0, 190.0, 36.0 ],
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-34", 0 ],
									"midpoints" : [ 227.5, 249.0, 189.5, 249.0 ],
									"source" : [ "obj-16", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 189.5, 270.0, 392.5, 270.0 ],
									"source" : [ "obj-16", 0 ]
								}
