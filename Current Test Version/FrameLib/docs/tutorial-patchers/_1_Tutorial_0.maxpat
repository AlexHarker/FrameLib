...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 75.0, 218.0, 530.25, 5.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 75.0, 225.0, 495.0, 224.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 75.0, 185.0, 260.0, 29.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"text" : "Thanks for downloading and installing FrameLib! This tutorial series is for both beginners and experts and while you may feel inclined to jump between tutorials initially, I would encourage you to navigate them in order.\n\nTo begin with, this first tutorial will cover some absolute basics of digital signal procesisng that will function as a useful refresher or crash course. It will cover some concepts such as digital sampling and highler level concepts that will make FrameLib make sense.\n\nAfter this, you'll be thrown into the world of frame-based processing and qiuckly be on your way to building your own custom granular synthesiser engine. This encompasses the first six tutorials, and after these you will be introduced to advanced concepts such as spectral processing. Finally, deeper capabilities of FrameLib will be explored including its multi-threading behaviour and executing FrameLib networks in non-realtime Max threads."
								}
...
,
					"patching_rect" : [ 555.0, 104.0, 81.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
