...
,
					"patching_rect" : [ 315.0, 582.0, 147.0, 21.0 ],
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"patching_rect" : [ 23.0, 201.0, 56.0, 22.0 ],
													"sig" : 0.0
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "signal" ],
													"patching_rect" : [ 23.0, 155.666666666666686, 183.0, 22.0 ],
													"text" : "fl.trace~ /position 0.5 /mode ratio"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 22.0, 14.0, 250.0, 38.0 ],
													"text" : "This little network belongs to the default context, the same as the network above!"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 23.0, 110.333333333333343, 122.0, 22.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 23.0, 65.0, 94.0, 22.0 ],
...
,
									"patching_rect" : [ 477.0, 315.0, 100.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 30.0, 444.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 195.0, 444.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 195.0, 399.0, 58.0, 22.0 ],
									"text" : "fl.tomax~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 195.0, 354.0, 142.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 30.0, 399.0, 58.0, 22.0 ],
									"text" : "fl.tomax~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 30.0, 354.0, 115.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 30.0, 309.0, 94.0, 22.0 ],
									"text" : "fl.interval~ 1024"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 15.0, 60.0, 690.0, 194.0 ],
									"text" : "Up and till now the concept of a FrameLib context hasn't been explained or even made explicit to you but they are important to know for the more advanced capabilities that you're about to learn.\n\nEvery FrameLib object, or set of objects that are connected belong to a 'context'. When a FrameLib object is instantiated, it belongs to the default which is essentially an unnamed identifier or blank symbol (\"\").  Till now, every example or demonstration has been a patch belonging to the default context and this aspect hasn't been changed or managed. \n\nBy default, there is only one context per top-level patcher (the default one) which extends downards into all sub-patchers. The only exception to this is if there is a poly~ that contains Objects don't have to belong to the default context though, and new contexts can be created and then managed through some attributes (yes attributes!) and the fl.context~ object."
								}
...
,
					"patching_rect" : [ 150.0, 582.0, 61.0, 21.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
