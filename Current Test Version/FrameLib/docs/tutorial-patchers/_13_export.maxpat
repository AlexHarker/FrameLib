...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 15.0, 540.0, 90.0, 60.0 ],
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 506.0, 190.0, 80.0, 24.0 ],
									"text" : "<path>",
									"textcolor" : [ 0.262745098039216, 0.43921568627451, 0.274509803921569, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 435.0, 190.0, 69.0, 24.0 ],
									"text" : "<name>",
									"textcolor" : [ 0.588235294117647, 0.2, 0.298039215686275, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 375.0, 190.0, 57.0, 24.0 ],
									"text" : "export"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"numoutlets" : 0,
									"patching_rect" : [ 15.0, 615.0, 60.0, 60.0 ]
								}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 80.0, 75.0, 86.0, 20.0 ],
													"text" : "random offset"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 3,
													"outlettype" : [ "", "", "" ],
													"patching_rect" : [ 47.0, 116.0, 138.0, 22.0 ],
													"text" : "fl.info~ fl.tut.13 /units ms"
												}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "signal" ],
									"patching_rect" : [ 15.0, 495.0, 90.0, 23.0 ],
									"text" : "fl.sink~ =2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 15.0, 315.0, 154.0, 23.0 ],
									"text" : "fl.read~ fl.tut.13 /units ms"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 90.0, 652.0, 166.0, 23.0 ],
									"text" : "buffer~ fl.tut.13 sho0630.aif"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 15.0, 135.0, 204.0, 23.0 ],
									"text" : "fl.interval~ =8 50 ms @id exporter"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "Exporting code is extremely simple: all it requires is that you send the export message to a network of connected FrameLib objects. The network below and to the left will be exported by addressing its context through fl.contextcontrol~ on the right."
								}
...
, 							{
								"box" : 								{
									...
									"text" : "An example of the code export feature"
								}
...
,
					"patching_rect" : [ 129.0, 60.0, 68.0, 21.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 13.0,
...
,
					"patching_rect" : [ 30.0, 60.0, 87.0, 21.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
		...
		"lines" : [  ],
		"parameters" : 		{
			"obj-1::obj-32::obj-50" : [ "live.gain~[1]", "Volume", 0 ],
			"parameterbanks" : 			{
