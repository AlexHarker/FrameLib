...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 183.25, 46.0, 21.0 ],
					"style" : "",
					"text" : "fl.log2~"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 11.595187,
					"id" : "obj-80",
					"items" : [ "(Objects:)", ",", "<separator>", ",", "fl.log~", ",", "fl.log10~", ",", "<separator>" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Calculates the logarithm base 2 of each value in the input frame.",
					"textcolor" : [ 0.2, 0.2, 0.2, 1.0 ],
