                        ...
                        "boxes": [
                            {
                                "box": {
                                    ...
                                    "text": "FROM ALEX - should explain here that the gate works faster on higher frequencies but you get the resolution at low freqs"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "text": "FROM ALEX - the FFT window size (N) is not the size of frames here - these are N/2+1"
                                }
                            },
                            {
                                "box": {
                                        ...
                                        "boxes": [
                                            {
                                                "box": {
                                                    ...
                                                    "text": "Here we design 4 filters to filter each FFT into bands (shorter FFTs for the higher frequencies)"
                                                }
                                            },
                                            {
                                                "box": {
